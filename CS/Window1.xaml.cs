...
namespace DXGrid_ConditionalFormatting {
    public partial class Window1 : Window {
        public Window1() {
            InitializeComponent();
            Style st= this.FindResource(new GridRowThemeKeyExtension{ResourceKey= GridRowThemeKeys.LightweightCellStyle, ThemeName="Office2016White"}) as Style;            
            newStyle = new Style(typeof(LightweightCellEditor),st);
            Setter s = new Setter();
