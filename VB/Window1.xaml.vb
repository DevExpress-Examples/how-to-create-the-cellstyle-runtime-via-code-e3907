...
Namespace DXGrid_ConditionalFormatting
    Partial Public Class Window1
        ...
        Public Sub New()
            InitializeComponent()
            Dim st As Style= TryCast(Me.FindResource(New GridRowThemeKeyExtension With { _
                .ResourceKey= GridRowThemeKeys.LightweightCellStyle, _
                .ThemeName="Office2016White" _
            }), Style)
